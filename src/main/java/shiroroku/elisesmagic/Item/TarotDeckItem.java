...
public class TarotDeckItem extends Item implements MenuProvider {
	private static final TagKey<Item> tarot = TagKey.create(Registry.ITEM_REGISTRY, new ResourceLocation(ElisesMagic.MODID, "tarot_cards"));

	public TarotDeckItem() {
		super(new Item.Properties().tab(ElisesMagic.CREATIVETAB).stacksTo(1).rarity(Rarity.UNCOMMON));
	}
